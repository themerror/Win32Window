...
namespace ConsoleApp1
{
	...
	public enum ShowWindowCommands : int
	{
		...
		/// <summary>
		/// Displays the window as a minimized window. This value is similar to <see
		/// cref="Win32.ShowWindowCommand.ShowMinimized"/>, except the window is not activated.
		/// </summary>
		ShowMinNoActive = 7,

		/// <summary>
		/// Displays the window in its current size and position. This value is similar to <see
		...
		/// <summary>
		/// <b>Windows 2000/XP:</b> Minimizes a window, even if the thread that owns the window is
